                    ...
                    <div class="done_amount">
                        ...
                        <div class="done_amount_have">
                            ...
                            <div>
                                ...
                                <span class="done_have_item">{{surplus}}</span>
                            </div>
...
export default {
    ...
    beforeMount() {
        ...
        api('/interface.php/V1/Activity/detail',params)
        .then(res => {
             if(res.success == 200){
    ...
    methods: {
        ...
        okBtn(){
            ...
            api('/interface.php/V1/PayOrder/createOrder',params)
            .then(res => {
                    // console.log(res.data)
                    if(res.success == 200){
