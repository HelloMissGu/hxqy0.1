<template>
    <div class="app_home">
        ...
        <div class="my-temple">
            ...
            <router-link :to="{path:'/donateDetail',query:{id:item.id}}"  v-for="(item,key) in templeList" :key="item.id">
            <div class="temple_item">
...
import exit from '../api/exit.js'
    export default {
        ...
        beforeMount() {
            ...
            api('/interface.php/V1/AppIndex/indexBanner',params)
             .then(res =>{
                if(res.success == 200){
            ...
            api('/interface.php/V1/AppIndex/indexNotice',params)
             .then(res =>{
                 if(res.success == 200){
            ...
            api('/interface.php/V1/AppIndex/indexData',params)
             .then(res =>{
                 if(res.success == 200){
            ...
            api('/interface.php/V1/AppIndex/indexScoreLog',params)
             .then(res =>{
                if(res.success == 200){
            ...
            api('/interface.php/V1/AppIndex/indexActivity',params)
             .then(res =>{
                if(res.success == 200){
